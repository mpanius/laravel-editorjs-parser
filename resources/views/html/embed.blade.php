<div class="editor-js-embed relative">
    ...
    @switch($data['service'])
        @case('youtube')
            ...
            >
                <iframe
                    src="https://cdn.viqeo.tv/embed/?videoSrc={{str_replace('&amp;','&',$data['embed'])}}playerId=4933" width="100%" height="100%" style="position:absolute;" frameBorder="0" allowFullScreen></iframe>
            </div>
            @break
        @case('vkontakte')
