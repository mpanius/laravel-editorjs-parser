<div class="editor-js-embed relative">
    ...
    @switch($data['service'])
        @case('youtube')
            ...
            >
                <iframe src="https://cdn.viqeo.tv/embed/?videoSrc={{str_replace('&amp;','&',$data['embed'])}}&playerId=4931" width="100%" height="100%" style="position:absolute;" frameBorder="0" allowFullScreen></iframe>
            </div>
            @break
        @case('vkontakte')
        ...
        @case('rutube')
            ...
            <script async src="https://telegram.org/js/telegram-widget.js?22" data-telegram-post="{{str_replace('https://t.me/','',\Illuminate\Support\Str::beforeLast($data['embed'],'?'))}}" data-width="100%"></script>
            @break
        @default
